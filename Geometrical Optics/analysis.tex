...
\begin{Lrtable}{vptlvalues}{thinlens}
...
{Plot of the values from \cref{tab:vptlvalues}}
    ...
    \addplot[only marks] table[x=1/s_i,y=1/s_o] {"\Experiment/Tables/thinlens.txt"};
...
{Plot of the values from \cref{tab:vpmagvalues}}
    ...
    \addplot[only marks] table[x=s_o,y=1/M] {"\Experiment/Tables/magnification.txt"};
